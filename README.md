...
The standalone sandbox demo at `/sandbox-demo.html` remains fixture-backed, but the
main application uses the shared Clerk client and launches the sandbox against the
authenticated API.
