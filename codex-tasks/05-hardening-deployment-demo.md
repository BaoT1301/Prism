# Task 05 â€” Hardening, Deployment, and Demo Readiness

Read all instructions and inspect the complete application.

## Goal

Make the backend reliable, secure, deployable, and easy for the six-person team to integrate.
...
- Logging
- SQL safety
- Rate limits on costly AI endpoints
...
- Demo fallback
- Provider and request IDs in logs
...
- Build/import smoke check

Do not require production secrets.

### Seed/demo

Create documented, idempotent demo seed tooling:

- Teacher
- Thre…11573 tokens truncated…        UUID PK
