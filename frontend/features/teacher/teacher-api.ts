...
import { ensureCollectionShape } from "../../lib/guards";
...
export function createTeacherApi(getAccessToken?: AccessTokenProvider) {
  return {
    ...
    submissions: async (id: string) => ensureCollectionShape(await apiRequest<Collection<Submission>>(`/api/v1/assignments/${id}/submissions`, {}, getAccessToken)),
